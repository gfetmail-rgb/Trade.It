namespace Trade.It
{
    partial class Form1
    {
        ...
        private GroupBox CreateNameFilterGroup()
        {
            ...
            var phraseLabel = CreateLabel("عبارت:");
            phraseLabel.Width = 55;
            var phraseTextBox = new TextBox { Width = 100, Margin = new Padding(4, 4, 8, 4), PlaceholderText = "مثلاً X" };

            panel.Controls.Add(phraseTextBox);
            panel.Controls.Add(phraseLabel);
            panel.Controls.Add(CreateRadioButton("همه", true));
        ...
        {
            var group = CreateGroupBox("۳ ـ نسبت حجم آخرین کندل به میانگین کندل‌های قبل");
            var panel = CreateOptionPanel();
        ...
        {
            var group = CreateGroupBox("۵ ـ مقایسه قیمت بین دو روز");
            ...
            var firstDay = new FlowLayoutPanel { Dock = DockStyle.Fill, AutoSize = true, FlowDirection = FlowDirection.RightToLeft, WrapContents = false };
            firstDay.Controls.Add(CreateLabel("روز اول: x روز قبل"));
            firstDay.Controls.Add(CreateNumericTextBox("X", 55));
            panel.Controls.Add(firstDay, 0, 1);

            var secondDay = new FlowLayoutPanel { Dock = DockStyle.Fill, AutoSize = true, FlowDirection = FlowDirection.RightToLeft, WrapContents = false };
            secondDay.Controls.Add(CreateLabel("روز دوم: y روز قبل"));
            secondDay.Controls.Add(CreateNumericTextBox("Y", 55));
            panel.Controls.Add(secondDay, 1, 1);

            panel.Controls.Add(CreateLabel("رابطه:"), 0, 2);
            panel.Controls.Add(CreateComboBox(new[] { "بزرگتر از", "مساوی", "نامساوی", "کوچکتر از", "بزرگتر یا مساوی", "کوچکتر یا مساوی" }, 150), 1, 2);

            var description = new Label
            {
                Text = "قیمت انتخاب‌شده در x روز قبل با همان قیمت در y روز قبل مقایسه می‌شود.",
                AutoSize = true,
                Dock = DockStyle.Fill,
        ...
        private FlowLayoutPanel CreateOptionPanel()
        {
        ...
        private RadioButton CreateRadioButton(string text, bool selected = false)
        {
        ...
        private Label CreateDateLabel(string text)
        {
            return new Label
            {
                ...
                AutoSize = true,
                ForeColor = SystemColors.GrayText,
                Margin = new Padding(10, 7, 5, 5),
                Font = new Font("Segoe UI", 9F, FontStyle.Italic)
            };
        }

        private TextBox CreateNumericTextBox(string placeholder, int width)
        {
            return new TextBox
            {
                Width = width,

namespace Trade.It
{
    partial class PortfolioDefinitionForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            namePanel.ColumnStyles.Add(new ColumnStyle(SizeType.Absolute, 110F));
            ...
            sourceGroup.Padding = new Padding(12, 8, 12, 6);
            ...
            var sourceFlow = new FlowLayoutPanel { Dock = DockStyle.Fill, FlowDirection = FlowDirection.RightToLeft, WrapContents = false };
            sourceFlow.Controls.Add(fileNameRadioButton);
            sourceFlow.Controls.Add(insideFileRadioButton);
            ...
            pathPanel.ColumnStyles.Add(new ColumnStyle(SizeType.Absolute, 140F));
            ...
            generalPanel.ColumnStyles.Add(new ColumnStyle(SizeType.Absolute, 75F));
            generalPanel.ColumnStyles.Add(new ColumnStyle(SizeType.Absolute, 190F));
            generalPanel.ColumnStyles.Add(new ColumnStyle(SizeType.Absolute, 65F));
            generalPanel.ColumnStyles.Add(new ColumnStyle(SizeType.Absolute, 190F));
            generalPanel.ColumnStyles.Add(new ColumnStyle(SizeType.Absolute, 175F));
            ...
            headerCheckBox.Text = "سطر اول عنوان ستون‌ها"; headerCheckBox.AutoSize = true; headerCheckBox.Anchor = AnchorStyles.Left | AnchorStyles.Right; generalPanel.Controls.Add(headerCheckBox, 4, 0);
            noDateTimeCheckBox.Text = "داده فاقد تاریخ/زمان است"; noDateTimeCheckBox.AutoSize = true; noDateTimeCheckBox.Anchor = AnchorStyles.Left | AnchorStyles.Right; generalPanel.Controls.Add(noDateTimeCheckBox, 5, 0);
            ...
            timeFormatCheckBox.Text = "فرمت زمان:"; timeFormatCheckBox.AutoSize = true; timeFormatCheckBox.Anchor = AnchorStyles.Left | AnchorStyles.Right; formatPanel.Controls.Add(timeFormatCheckBox, 0, 0);
            ...
            dateFormatCheckBox.Text = "فرمت تاریخ:"; dateFormatCheckBox.AutoSize = true; dateFormatCheckBox.Anchor = AnchorStyles.Left | AnchorStyles.Right; formatPanel.Controls.Add(dateFormatCheckBox, 2, 0);
            ...
            var middle = new TableLayoutPanel { Dock = DockStyle.Fill, ColumnCount = 2, RowCount = 1, RightToLeft = RightToLeft.Yes, Padding = new Padding(0, 4, 0, 4) };
            ...
            symbolSelectionGroup.Controls.Add(symbolLayout);
            ...
            mainTable.Controls.Add(previewGroup, 0, 7);

            var bottom = new FlowLayoutPanel { Dock = DockStyle.Fill, FlowDirection = FlowDirection.RightToLeft, WrapContents = false, Padding = new Padding(0, 8, 0, 4), RightToLeft = RightToLeft.Yes };
            ...
            mainTable.Controls.Add(bottom, 0, 8);

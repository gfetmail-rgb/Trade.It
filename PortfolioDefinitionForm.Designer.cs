namespace Trade.It
{
    partial class PortfolioDefinitionForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            previewColumn1.Width = 150;
            previewColumn2.Width = 150;
            previewColumn3.Width = 150;
            previewColumn4.Width = 150;
            previewColumn5.Width = 150;
            previewColumn6.Width = 150;
            previewColumn7.Width = 150;
            previewColumn8.Width = 150;
            previewColumn9.Width = 150;
            previewColumn10.Width = 150;
            previewColumn11.Width = 150;
            previewColumn12.Width = 150;
            previewColumn13.Width = 150;
            previewColumn14.Width = 150;
            previewColumn15.Width = 150;
            previewColumn16.Width = 150;
            previewColumn17.Width = 150;
            previewColumn18.Width = 150;
